...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            new Neighbour(1, "Caroline", "http://i.pravatar.cc/150?u=a042581f4e29026704d", "06 05 12 20 65", "Paris", "Sed cautela nimia in peiores haeserat plagas, ut narrabimus postea, aemulis consarcinantibus insidias graves. Provincias amnis mare Gnaeus Orontes abstractas Tigrane praetermeans.","www.facebook.fr/caroline"),
